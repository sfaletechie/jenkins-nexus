    ...
    stages {
        ...
        stage("deployOnTest"){
            steps{
                ...
                deploy adapters: [tomcat7(credentialsId: 'tomcat7details', path: '', url: 'http://192.168.29.22:8080/')], contextPath: '/app', onFailure: false, war: '**/*.war'
            }
        }
        stage("deployOnPROD"){\
             input {
            ...
            steps{
                ...
                deploy adapters: [tomcat7(credentialsId: 'tomcat7details', path: '', url: 'http://192.168.29.42:8081/repository/simpleapp-release/')], contextPath: '/app', onFailure: false, war: '**/*.war'
            }
        }
    }
    post{
